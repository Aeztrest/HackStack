          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="w-full h-[260px] md:h-[320px] rounded-2xl overflow-hidden mt-4">
                  <iframe
                    title="Yenibosna Konum"
                    src="https://www.google.com/maps?q=Yenibosna, İstanbul, Türkiye&output=embed"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
                    loading="lazy"

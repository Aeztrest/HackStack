        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                {isLoggedIn ? (
                  <Link href="/taleplerim" className="text-neon-green hover:text-neon-green/80 transition-colors">
                    Taleplerim
                  </Link>
                ) : (
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 text-muted-foreground">
                ...
                <a href="mailto:iletisim@hackstack.com.tr" className="hover:underline">
                  iletisim@hackstack.com.tr
                </a>
              </li>
              <li className="flex items-center gap-2 text-muted-foreground">
                <Phone className="w-5 h-5 text-neon-blue" />
                <a href="tel:+905352260245" className="hover:underline">
                  +90 535 226 02 45
                </a>
              </li>
            </ul>
